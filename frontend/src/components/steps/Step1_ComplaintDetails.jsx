  ...
  return (
    <form id="step1-form" onSubmit={handleSubmit(onSubmit)} className="w-full">
      ...
      <div className="flex justify-between items-start mt-1">
        ...
        {(isFocused || descriptionValue.length > 0) && (
